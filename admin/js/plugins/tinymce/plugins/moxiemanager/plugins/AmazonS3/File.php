...
class MOXMAN_AmazonS3_File extends MOXMAN_Vfs_BaseFile {
	...
	public function __construct(MOXMAN_Vfs_FileSystem $fileSystem, $path, $stat = null) {
		...
		// Normalize path S3 doesn't support all kinds of blob names
	...
	public function getUrl() {
		...
		$prefix = $fileSystem->getBucketOption("urlprefix");

		return $prefix ? MOXMAN_Util_PathUtils::combine($prefix, $fileSystem->getBucketOption("name") . $this->getInternalPath()) : "";
	}
