...
// General
$moxieManagerConfig['general.license'] = '7SFD-POXT-5AUF-YIVI-AHWF-OPRM-JAJY-LH6Y';
...
// Filesystem
$moxieManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'] . _SITE_PATH . '/uploads';
...
$moxieManagerConfig['storage.path'] = $_SERVER['DOCUMENT_ROOT'] . _SITE_PATH . '/uploads';
...
//array("username" => "test", "password" => "test", "groups" => array("administrator"))
//);
