...
class cache_sqlite extends Cache implements Driver  
{
    ...
    {
        return (extension_loaded('pdo_sqlite') && is_writeable($this->getPath())) ? true : false;
    }
    ...
    {
        return (isset($row['exp']) && @date('U') >= $row['exp']) ? true : false;
    }
    ...
    public function driver_isExisting($keyword) 
    {
        ...
        return ($data['total'] >= 1) ? true : false;
    }
}