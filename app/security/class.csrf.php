...
class Csrf
{
     ...
     * @return void
     */
    public static function generate_token($token_name = self::TOKEN_NAME)
    {
     ...
     * @return string
     */
    public static function get_token($token_name = self::TOKEN_NAME)
    {
        if (empty($_SESSION[$token_name])) {
            static::generate_token($token_name);
        }
     ...
     * @return string
     */
    public static function get_token_name($token_name = self::TOKEN_NAME)
    {
        return $token_name;
    }
    ...
    public static function validate($request_data = [], $token_name = self::TOKEN_NAME)
    {
        ...
        return static::compare($request_data[$token_name], static::get_token($token_name));
    }
     ...
     * @return string
     */
    public static function get_hidden_input_string($token_name = self::TOKEN_NAME)
    {
        return sprintf('<input type="hidden" name="%s" value="%s"/>', $token_name, static::get_token($token_name));
    }
     ...
     * @return string
     */
    public static function get_query_string($token_name = self::TOKEN_NAME)
    {
        return sprintf('%s=%s', $token_name, static::get_token($token_name));
    }
     ...
     * @return array
     */
    public static function get_token_as_array($token_name = self::TOKEN_NAME)
    {
        return [
            $token_name => self::get_token($token_name)
        ];
    }
