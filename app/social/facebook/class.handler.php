...
class Handler extends Facebook
{
    /**
    ...
    public function __construct($config)
    {
        if (!isset($config['appId']) || !isset($config['secret'])) {
            throw new Exception('Sorry, You must specify the appId and secret when initializing the class.', 500);
        }
    ...
    {
        return $this->_apiCall('likes', [], $objectId);
    }
    /**
     * attend an event
     * @param int $objectId object id that you want to like
    ...
    {
        return $this->_apiCall('attending', [], $objectId);
    }
    /**
    ...
    {
        return $this->_apiCall('maybe', [], $objectId);
    }
    /**
    ...
    {
        return $this->_apiCall('declined', [], $objectId);
    }
    /**
