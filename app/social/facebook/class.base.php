...
abstract class Base
{
    ...
    public function getLoginUrl($params = [])
    {
        ...
        return $this->getUrl('www', 'dialog/oauth', array_merge(
            [
    ...
    protected function getUserAccessToken()
    {
        ...
        if ($signed_request) {
            ...
            // if there's an authorization code or something
        }
    ...
    protected function getAccessTokenFromCode($code, $redirect_uri = null)
    {
        ...
        try {
            ...
            $access_token_response = $this->_oauthRequest($this->getUrl('graph', '/oauth/access_token'), $params = [
                'client_id' => $this->getAppId() ,
