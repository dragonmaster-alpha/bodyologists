...
?>
    <li <?=($open_plugin == 'subscriptions') ? 'class="current"' : ''?>>
        <a href="admin.php?plugin=subscriptions">Subscriptions</a>
    </li>
<?php
...
$_addon_dir = $_SERVER['DOCUMENT_ROOT']._SITE_PATH.'/plugins/subscriptions/addons';
